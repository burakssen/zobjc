...
pub const Property = extern struct {
    value: raw.objc_property_t,

    /// Returns the name of a property.
    pub fn getName(self: Property) [:0]const u8 {
        return std.mem.span(raw.runtime.property_getName(self.value));
    }

    /// Returns the value of a property attribute given the attribute name.
    pub fn copyAttributeValue(self: Property, attr: [:0]const u8) ?[:0]u8 {
        const ptr = raw.runtime.property_copyAttributeValue(self.value, attr.ptr) orelse return null;
